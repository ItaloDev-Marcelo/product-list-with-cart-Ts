...
const OrderCart = ({orderData, handleRemove}:OrderFormate) => {
  ...
  return (
    <div className=' w-[330px] md:w-[350px] xl:w-[400px] p-3  bg-white rounded-[7px] m-4'>
        <h3 className='font-black text-bt-Orange-0 text-[1.3em] pl-2'>Your Cart ({numOfCartItems}) </h3>
        {
          numOfCartItems <= 0 ?
          ...
          : (<div className='mb-4'>
           ...
           <div>
            ...
            px-1.5 py-3 h-[50px] my-2.5'>
                 <p>order total</p> 
                 <h5 className='font-black text-rose-900 text-[1.4em]'>${totalPrice.toFixed(2)} </h5>
            </div>
