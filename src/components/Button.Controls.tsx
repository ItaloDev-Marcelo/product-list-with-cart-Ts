...
const ButtonControls = ({Add, Remove, display, name}:ButtonFormate ) => {
  ...
  return (
    <div className='bg-bt-Orange-0 text-white w-[200px] lg:w-[175px] h-[50px] flex justify-between 
    items-center px-4 rounded-[25px]'>
        ...
        <div><button onClick={() => Remove(name)}> <div className='border-1 rounded-[50%] p-2 py-3 mt-2'><img src={Descress} alt=''/></div></button></div>
    </div>
  )
}
