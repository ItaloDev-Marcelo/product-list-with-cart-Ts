  ...
  return (
    <div>
        <div className="relative">
            <figure>
                 <img src={image?.mobile} alt='some dessert mm'  className={`rounded-[5px] md:hidden w-[330px] overflow-hidden ${count > 0 ? 'outline-2' : ''}` } />
                 <img src={image?.tablet} alt='some dessert tt' className={`rounded-[5px] hidden md:block xl:hidden  md:w-[350px] overflow-hidden ${count > 0 ? 'outline-2' : ''}`} />
                 <img src={image?.desktop} alt='some dessert ll' className={`rounded-[5px] hidden md:hidden xl:block  xl:w-[300px] overflow-hidden ${count > 0 ? 'outline-2' : ''}`} />
            </figure>
